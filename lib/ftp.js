    ...
    try {
        ...
        if (valid) {
            ...
            if (flag === "GETLISTFILES") {
                ...
                return {result:resultFTP, flag: properties.flag};
                ...
                return {result:myBuffer.toString(encoding), flag: properties.flag};
                ...
                return {result:`File ${properties.file} was created successfully.`, flag: properties.flag};
            } else if (flag === "CREATEDIRECTORY") {
                await client.ensureDir(properties.path);
                return {result:`Directory ${properties.path} was created successfully.`, flag: properties.flag};
            } else if (flag === "DELETEFILE") {
                await client.remove(properties.file);
                return {result:`File ${properties.file} was deleted successfully.`, flag: properties.flag};
                ...
                return {result:`Directory ${properties.path} was deleted successfully.`, flag: properties.flag};
            } else if (flag === "RENAMEFILE") {
                await client.rename(properties.file, properties.newName);
                return {result:`File ${properties.file} was successfully renamed to ${properties.newName}.`, flag: properties.flag};
            } else if (flag === "DOWNLOADDIR") {
                await client.downloadToDir(properties.localPath, properties.path);
                return {result:`Remote directory ${properties.path} was successfully downloaded to ${properties.localPath}.`, flag: properties.flag};
            } else if (flag === "UPLOADDIR") {
                try {
                    await client.uploadFromDir(properties.localPath, properties.path);
                    return {result:`Local directory ${properties.localPath} was successfully uploaded to ${properties.path}.`, flag: properties.flag};
                } catch (e) {
                    c.end();
                    throw Error(e);
                }
